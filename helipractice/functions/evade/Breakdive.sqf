...
[
player, ["breaklow", "Fly to destination, keep an altitude of at least 100m, and perform a breaklow once shot upon.", "Fly to destination.", "Destination", _toPos, "assigned"]
] call FHQ_TT_addTasks;

//waitUntil {((position HELI_CURRENT_VEHICLE) select 2) > 100};
...
{
	_text = "<t align='center' valign='middle' size='1.8'>Break dive now!</t>";
...
if(_diffDir < 90 || _diffAltitude < 70) exitWith { false; };

FHQ_TTI_supressTaskHints = false;
["breaklow", "succeeded"] call FHQ_TT_setTaskState;
